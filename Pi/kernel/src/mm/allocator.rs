...
use crate::arch::mmu::{Page, PageTableFlags, BootInfoFrameAllocator, OffsetPageTable, MapToError};
...
pub fn init_heap(
    ...
    for i in 0..num_pages {
        ...
        // Use Normal memory (write-back) for heap with read-write permissions
        let flags = PageTableFlags::VALID
            | PageTableFlags::ATTR_INDEX_1  // Normal, Write-back
            | PageTableFlags::AP_RW
            | PageTableFlags::AF;
        unsafe {
