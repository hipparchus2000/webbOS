...
fn get_char_bitmap(ch: char) -> [u8; 8] {
    match ch {
        ...
        // Lowercase letters (proper lowercase shapes)
        ...
        '•' => [0x00, 0x00, 0x00, 0x3c, 0x3c, 0x00, 0x00, 0x00],  // Bullet (for passwords)
        '.' => [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00],  // Period
        ',' => [0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x30],  // Comma
        ':' => [0x00, 0x18, 0x18, 0x00, 0x18, 0x18, 0x00, 0x00],  // Colon
        '/' => [0x00, 0x02, 0x06, 0x0c, 0x18, 0x30, 0x60, 0x00],  // Slash
        '-' => [0x00, 0x00, 0x00, 0x7e, 0x00, 0x00, 0x00, 0x00],  // Hyphen/minus
        '_' => [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7e, 0x00],  // Underscore
        '@' => [0x3c, 0x66, 0x6e, 0x6e, 0x60, 0x66, 0x3c, 0x00],  // At sign
